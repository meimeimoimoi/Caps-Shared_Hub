namespace Caps.Common.Wrappers;
...
public sealed record PagedResponse<T>(bool Success, IReadOnlyList<T> Items, int Page, int PageSize, long Total, string? Message = null);
